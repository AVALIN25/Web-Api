...
def update_category(db: Session, category_id: int, category_data: Union[schemas.CategoryUpdate, dict]):
...
def update_item(db: Session, item_id: int, item_data: Union[schemas.ItemUpdate, dict]):
